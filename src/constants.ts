export enum TARGET_NAME {
  INPAGE = 'altmask-inpage',
  CONTENTSCRIPT = 'altmask-contentscript',
  BACKGROUND = 'altmask-background',
}
...
export enum API_TYPE {
  ...
  GET_INPAGE_ALTMASK_ACCOUNT_VALUES = 'GET_INPAGE_ALTMASK_ACCOUNT_VALUES',
  SEND_INPAGE_ALTMASK_ACCOUNT_VALUES = 'ALTMASK_ACCOUNT_CHANGED',
  CONNECT_INPAGE_ALTMASK = 'CONNECT_ALTMASK',
...
export enum MESSAGE_TYPE {
  ...
  GET_INPAGE_ALTMASK_ACCOUNT_VALUES = 'GET_INPAGE_ALTMASK_ACCOUNT_VALUES',
  SEND_INPAGE_ALTMASK_ACCOUNT_VALUES = 'SEND_INPAGE_ALTMASK_ACCOUNT_VALUES',
}
...
export enum ALTMASK_ACCOUNT_CHANGE {
